...
const mapEntryForRequest = (
  ...
  if (mappingRow.overrides?.tags && !Array.isArray(mappingRow.overrides.tags)) {
  ...
  return {
    entry: {
      ...
      billable: mappingRow.overrides?.billable || false,
      tags: mappingRow.overrides?.tags || [],
      description: mappingRow.overrides?.description || entry.description,
      start: entry.start,
      stop: entry.stop,
